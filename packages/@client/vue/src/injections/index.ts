import type { EmotesProvidersInterface, ProvidersInterface } from '@client/shared';
 ...
 */
import type { createAccount, createChat, createEmotes, createLibrary, createSettings } from '@client/core';
...
export const Injection = {
  ...
  Module: {
    ...
    Settings: Symbol('settings module') as InjectionKey<Awaited<ReturnType<typeof createSettings>>>,
  },
} as const;
