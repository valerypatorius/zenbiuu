import { AbstractEmotesProvider, type EmoteEntity, type EmotesProviderApiInterface } from '@client/shared';
...
export default class BTTV extends AbstractEmotesProvider implements EmotesProviderApiInterface {
  ...
  public async getChannelEmotes(id: string): Promise<Record<string, EmoteEntity>> {
    ...
    return [...response.channelEmotes, ...response.sharedEmotes].reduce<Record<string, EmoteEntity>>(
      (result, rawEmote) => {
        /**
         * @todo Improve ofc
         */
